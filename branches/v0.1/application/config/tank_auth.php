...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'F1 Manager';
$config['webmaster_email'] = 'info@alleenf1.nl';
...
$config['recaptcha_public_key'] = '6LfFntASAAAAAMjj7b0DqtNrKBtDjyzwTqfUdYwJ';
$config['recaptcha_private_key'] = '6LfFntASAAAAAM3HNpU1ibtGDe-7C_8R5UgxZBUp ';
